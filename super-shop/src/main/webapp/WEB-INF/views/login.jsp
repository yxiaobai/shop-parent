        ...
        <div class="row margin-bottom-40">
            ...
            <div class="sidebar col-md-3 col-sm-3">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    <li class="list-group-item clearfix"><a href="${path}/register.jsp"><i
                            class="fa fa-angle-right"></i>
                        会员注册</a></li>
                    <li class="list-group-item clearfix"><a href="${path}/modPass.jsp"><i class="fa fa-angle-right"></i>
                        修改密码</a>
                    </li>
                    <li class="list-group-item clearfix"><a href="${path}/myAccount.jsp"><i
                            class="fa fa-angle-right"></i> 我的账户</a>
                    </li>
                    <li class="list-group-item clearfix"><a href="${path}/addreeList.jsp"><i
                            class="fa fa-angle-right"></i> 地址薄</a>
                    </li>
                    <li class="list-group-item clearfix"><a href="${path}/wishList.jsp"><i
                ...
                <div class="content-form-page">
                    <div class="row">
                        <div class="col-md-7 col-sm-7">
                            <form action="${path}/login" id="loginForm" class="form-horizontal form-without-legend"
                                  method="post">
                                <div class="form-body">
