...
<div role="navigation" class="navbar header no-margin">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="${path}/index.jsp" class="navbar-brand"><img
                    src="${path}/assets/img/logo_red.png" alt="author by zhanglingsi"></a><!-- LOGO -->
        </div>
        <!-- BEGIN CART -->
        <div class="cart-block">
            <div class="cart-info">
                <a href="${path}/car-list.jsp" class="cart-info-count">${carNum!=null?carNum:0} 项</a>
                <a href="${path}/car-list.jsp" class="cart-info-value">￥1260</a>
            </div>
            ...
            <div class="cart-content-wrapper">
                <div class="cart-content">
                    ...
                    <div class="text-right">
                        <a href="${path}/car-list.jsp" class="btn btn-default">购物车</a>
                        <a href="${path}/order" class="btn btn-primary">结算</a>
                    </div>
                </div>
            </div>
            <!-- END CART CONTENT -->
